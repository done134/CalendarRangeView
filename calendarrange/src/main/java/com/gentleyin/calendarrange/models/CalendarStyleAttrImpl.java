...
public class CalendarStyleAttrImpl implements CalendarStyleAttributes {
    ...
    public static CalendarStyleAttrImpl getDefAttributes(@NonNull final Context context) {
        ...
        calendarStyleAttr.setSelectedDateCircleColor(ContextCompat.getColor(context, R.color.range_bg_color));
    ...
    private void setDefAttributes(@NonNull final Context context) {
        ...
        setSelectedDateCircleColor(ContextCompat.getColor(context, R.color.range_bg_color));
    ...
    private void setAttributes(@NonNull final Context context, @Nullable final AttributeSet attributeSet) {
        if (attributeSet != null) {
            final TypedArray ta = context.obtainStyledAttributes(attributeSet, R.styleable.VerticalRangeMonthView, 0, 0);
            try {
                titleColor = ta.getColor(R.styleable.VerticalRangeMonthView_title_color, titleColor);
                headerBg = ta.getDrawable(R.styleable.VerticalRangeMonthView_header_bg);
                weekColor = ta.getColor(R.styleable.VerticalRangeMonthView_week_color, weekColor);
                rangeStripColor = ta.getColor(R.styleable.VerticalRangeMonthView_range_color, rangeStripColor);
                selectedDateCircleColor = ta.getColor(R.styleable.VerticalRangeMonthView_selected_date_circle_color, selectedDateCircleColor);
                shouldEnabledTime = ta.getBoolean(R.styleable.VerticalRangeMonthView_enable_time_selection, false);
                isEditable = ta.getBoolean(R.styleable.VerticalRangeMonthView_editable, true);

                textSizeTitle = ta.getDimension(R.styleable.VerticalRangeMonthView_text_size_title, textSizeTitle);
                textSizeWeek = ta.getDimension(R.styleable.VerticalRangeMonthView_text_size_week, textSizeWeek);
                textSizeDate = ta.getDimension(R.styleable.VerticalRangeMonthView_text_size_date, textSizeDate);

                selectedDateColor = ta.getColor(R.styleable.VerticalRangeMonthView_selected_date_color, selectedDateColor);
                defaultDateColor = ta.getColor(R.styleable.VerticalRangeMonthView_default_date_color, defaultDateColor);
                rangeDateColor = ta.getColor(R.styleable.VerticalRangeMonthView_range_date_color, rangeDateColor);
                disableDateColor = ta.getColor(R.styleable.VerticalRangeMonthView_disable_date_color, disableDateColor);
                setWeekOffset(ta.getColor(R.styleable.VerticalRangeMonthView_week_offset, 0));
